...
# Load data
ps_df = pd.read_csv(r'E:\github projects\Footistics\FInal_DF\Positions_Mapped.csv')
fw_df = pd.read_csv(r'E:\github projects\Footistics\FInal_DF\df\fw_df.csv')
mf_df = pd.read_csv(r'E:\github projects\Footistics\FInal_DF\df\mf_df.csv')
df_df = pd.read_csv(r'E:\github projects\Footistics\FInal_DF\df\df_df.csv')
gk_df = pd.read_csv(r'E:\github projects\Footistics\FInal_DF\df\gk_df.csv')
...
# Load abbreviations
with open(r'E:\github projects\Footistics\src\abbrevation.json', 'r') as file:
    data = json.load(file)
